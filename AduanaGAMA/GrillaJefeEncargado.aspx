<%@ Page Language="C#" MasterPageFile="~/layout/LayoutPublic.Master" AutoEventWireup="true" CodeBehind="GrillaJefeEncargado.aspx.cs" Inherits="AduanaGAMA.GrillaJefeEncargado" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="row">
        <div class="col-12 col-sm-12 col-md-12">
            <div class="form-group text-right">
                <a href="Empleado.aspx" class="btn btn-primary ">crear jefe</a>
            </div>
        </div>
